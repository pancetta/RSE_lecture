...
# %%
# Visualize the Pull Request workflow
...
# Draw arrows
arrows = [
    (0, 1), (1, 2), (2, 3), (3, 4), (4, 5), (4, 6),  # Main flow
]
...
for start_idx, end_idx in arrows:
    ...
    if start_idx == 4 and end_idx in [5, 6]:  # Fork to review and CI
